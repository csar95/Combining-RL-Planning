...
class DDQNAgentNorm:
    ...
    def train(self):  # ,terminal):
        ...
        # Transition: (normalized_current_state, action, reward, normalized_next_state, next_state, done)
        ...
        for index, (normalized_current_state, action, reward, _, next_state, done) in enumerate(minibatch):
            if not done:
