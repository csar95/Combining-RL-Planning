...
if __name__ == '__main__':
    data_folder1 = "DoubleDQL"  # "DoubleDQL_Soft-Update (0.005)"
    data_folder2 = "DDQL_PR_3" # "DoubleDQL_Soft-Update (0.01)" "DoubleDQL_Hard-Update (500)"   "DDQL_PER (0.1)"    "DDQL_2ndEncoding (Z-score norm.)"  "DDQL_PR_1 (0.2)"
    data_folder3 = "DDQL_PR_3 (Lite)" # "DoubleDQL_Soft-Update (0.1)"  "DoubleDQL_Hard-Update (100)"   "DDQL_PER (0.7)"    "DDQL_2ndEncoding (NO norm.)"       "DDQL_PR_1 (0.8)"
    data_folder4 = "DDQL_PR_6" # "DoubleDQL_Soft-Update (0.5)"  "DoubleDQL_Hard-Update (50)"    "DDQL_PER (0.9)"    "DDQL_2ndEncoding (Min-Max norm.)"  "DDQL_PR_1"
